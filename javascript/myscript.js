...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim tớ đang đập " + (thePercent+899) + " nhịp trên phút";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Haiz...';
document.querySelector('.Description .modal-body').innerHTML = 'Biết ngay là bấm vào đây mà :) <br> Bấm close rồi chọn chữ click vào bên trên trái tim đi <i class="fas fa-heart"></i> ';
